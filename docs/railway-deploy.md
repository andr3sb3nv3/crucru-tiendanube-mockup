...
El worker revisa PostgreSQL cada segundo. Para las solicitudes programadas prepara el navegador 90 segundos antes, inicia sesion y espera hasta la hora exacta antes de consultar la grilla. El boton `Generar solicitud ahora` usa la misma cola y el mismo ejecutor.
